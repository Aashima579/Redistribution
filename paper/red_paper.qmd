...
- Contribution
Globally, women do the vast majority of the unpaid work, including child care, cooking, cleaning and farming. This unpaid work is essential for households and economies to function, but it restricts the care providers' capabilities by restricting their time availability and particpation in the labor market. For example, addressing the disparities in unpaid care work can lead to improved health and well-being for women and families and foster more equitable societies​(@oxfam2020). Moreover, informal caregivng exerts additional pressure on indivuidsulas time availability especially among employed people. Time poverty xxxx
Research and polciy spaces have often emphasized the 3R statetgy : recognize, reduce and redistribute unpaid work (@elson2017; @UN2015). Recognition focuses on  measuring time use in households and integrating them into national statistical systems; Reduction aims to expanding access to key infrastructure, and investing in time and labour-saving technologies; and Redistribution emphasize on implementing policies favourable to burden-sharing between women and men, such as maternity and paternity leave, and quality public care services, as well as eliminating gender wage gaps. 
In this paper our focus is on the redistribution aspect of the 3R framework. We explore if redistributing housheold production among hosuehold members can reduce time poverty, and promote gender equitable sharing of hh work. We look at the scope of reducing individual's time poverty ouctomes as well as if hosuheodls can be lifted out of income-adjusted time poverty.  


We first provide an overview of LIMTIP , moving on to how we
