---
title: "Can Redistribution of Household Production make Married Couple escape time poverty: Evidence from the United States?"
format:
  simart-pdf:  
    keep-tex: true  
    fontsize: 11pt
...
![](resources_brief/poverty_wmen.png){fig-align="center"}
...
![](resources_brief/poverty_other.png){fig-align="center"}
...
For households type II, it is interesting to notice that those who are time-poor face larger time deficits compared to people living in households type I. The redistribution scenario 1 drastically favors women, reducing their time deficit by 14 hours, although men would also see a reduction of 4 hours in their time deficit. Scenarios 2 and 3 had similar impacts reducing time deficits for men and women. In Scenario 2, time deficits declined by about 15 hours for both men and womena and in Scenario 3, by 8 hours for men and by 10 hours for women. Scenario 2 was most effective in reducing time deficits
...
::: {#fig-def1 fig-pos="H"}
![](resources_brief/tdef_men.png){fig-align="center"}

Time Deficits by Individual type: Men
:::

::: {#fig-def2 fig-pos="H"}
![](resources_brief/tdef_wmen.png){fig-align="center"}
...
::: {#fig-def3 fig-pos="H"}
![](resources_brief/tdef_other.png){fig-align="center"}
...
**we can consider adding something like this**
