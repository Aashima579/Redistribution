...
Over the time period 2015-19, the ratio of the share of houshold production of married women to married men has remain more or less stagnant such that wives share is 1.6 time more than husbands. Moreover wives are experiencing greater time deficits in the 
...
Redistribution across all three scenarios is effective in reducing the time-adjusted income poverty in turn reducing the proportion of hidden poor. In @fig-limtip we present the official income poverty estimates along with the baseline LIMTIP estimates and the LIMTIP for the three scenarios for couple households. The difference between the SPM poverty estimate and the LIMTIP estimates are the hidden poor, which decreases across all three scenarios. 
