...
<!--AS to merge some of the below to above
...
For the implementation of these scenarios, we consider that all other elements in LIMTIP equation <!--add a footnoteon the equation!-->  remain constant with the exception of $\alpha_{ij}$, which is the share of household production time that each individual $i$ in Household $j$ takes on.
