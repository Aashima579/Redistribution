...
For example, if there are only two working-age adults, say husband and
wife, and if the husband's potential hourly wage is twice as much as the
wife, the wife would have to do twice as much work as the husband.
...
model that corrects for sample selection (see (\textbf{wp\_qmatch?}) for
details).
