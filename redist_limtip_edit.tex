...
using averages for the years 2005-2023. As the table shows, time poverty
is a significant issue in the U.S., with 42.9\% of individuals living in
...
time-poor household is themselves time-poor. In fact, only 52.8\% of
...
time-poor households, the incidence of LIMTIP income poverty is 13.1\%,
compared to 6\% for official poverty, which suggests that just over 7\%
...
is time-poor. \\
Single Person Elig & 5.9\% & The household has only one working-age,
...
(60\%) compared to their partners (40\%), reflecting the
...
time poverty rate of 45\% in HH type II, just above the rate of
husbands, and 25.5\% in HH Type III. This suggests that some of the
...
considerable share (14.2\% to 26.1\%) of non-time poor men will fall
...
poverty (26.1\%). In contrast, see Figure~\ref{fig-transition2}, because
...
terms of transition into time poverty (8.3\%). The second scenario,
...
responsibilities compared to women. In consequence, while 14.2\% of
non-time poor men will fall into time poverty, 19.8\% of women will do
so under scenario 3.
...
time poverty are much higher (31\%) under scenario 1, and a small but
still larger 2\% under scenario 2. This suggests that both
redistribution scenarios may favor women/wives in these households.
...
of men and 71\% of women exit time poverty as a result of
...
men and women (72\%). However, the scenario that does the best in
...
couple (93\% men and 96\% women) is able to exit time poverty.
...
highest impact under Scenario 3 (11\%), still lower compared to couples
...
average, non-time poor individuals will face a time deficit of 0.8-1.6
hours per week, depending on the scenario. For those who fall into time
poverty, however, these changes imply an average time deficit between
5.5 to 6.1 hours per week. This is still small compared to the time
deficits of individuals who start as time-poor. For women, the average
time deficit for non-time poor individuals is 0.3-1.2 hours, or 3.6-6.2
hours for those who fall into time poverty. While falling into time
poverty is not ideal, it is interesting to note that men end up with a
larger time deficit compared to their partners.
...
marginal changes (±1 hour) in time deficits.
...
women, reducing their time deficit by 15 hours, although men would also
see a reduction of 5 hours in their time deficit. Scenarios 2 and 3
would have similar impacts on time deficits for men and women (15 hours
and 10 hours respectively). Albeit scenario 3 was more effective in
reducing time poverty, compared to scenario 2 which fosters a more
equitable redistribution of responsibilities.

Under scenario 3, both men and women (who were time-poor) have similar
time deficits before redistribution (about 10 hours per week). However,
after redistribution, the average time deficits among women practically
disappear, although reductions are less dramatic for men. In both cases,
the remarkable reduction in time deficits is explained by the large
poverty exit rates observed before. A simple transformation suggests
that, among men, those who remain time-poor still face a time deficit of
nearly 10 hours per week, except under scenario 2, where the time
deficit is reduced to 5.5 hours. For women who remain time-poor,
...
5.5-7.1 hours per week, depending on the scenario. This is still below
...
(\textasciitilde17 hours), but they seem to be somewhat indifferent
...
Figure~\ref{fig-limtip1}, only 4.8\% of individuals in time-poor
...
estimates show that 10.5\% of individuals live in time-poor households,
which translates to 5.7\% of individuals being hidden poor.
...
effects on time poverty, reducing the incidence of hidden poor to 1-2\%
for all households combined, with Scenario 2 (time availability) proving
to be the most effective in reducing hidden poverty. The decline in the
incidence of hidden poor is the highest for households Type II, about
4-5\%.
...
affecting 42.9\% of individuals living in time-poor households. Our
