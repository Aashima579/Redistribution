...
We specify our goal to bring households out of poverty and focus on only those households who can be brought of poverty. For this purpose, we identify the households with atleast one time poor and one time non-poor adult individual for us to redistribute effectively so that the hh can fall out of poverty. This excludes:
...
By the same logic we end up identifying household where we can :
...
First, we use the simple egalitarianism principle that involves an equal division. 
