...
In @tbl-limtip and @tbl-limtiph we present the average distribution of individuals and households, respectively, across the four-way classification of LIMTIP for the years from 2005 to 2022.
...
**Four-way classification of Individuals, LIMTIP **
...
:::{#fig-transition fig-pos="H"}

![](resources/def1.pdf){fig-align="center"}

Time Deficits changes across Scenarios 
...
Should we also add Heterogeneity Across Characteristics? for Deficit? How to ADD it?
