...
\{\textless{} include resources/Tables/tbl\_limtip.tex \textgreater\}
...
\{\textless{} include resources/Tables/tbl\_limtiph.tex \textgreater\}
...
out of time poverty, by taking on more household responsibilities. From
the rest, 4.6\% live in households where everyone is time poor, 7.1\%
live in households with at least one not-time-poor individual, but with
insufficient time surplus to lift the household out of time poverty, and
33.7\% live in households where there is enough time surplus to lift
every household member out of poverty.
...
individuals will fall into time poverty. However, as shown in
Figure~\ref{fig-deficit}, in average, the time deficit While this
probabilities is considerably similar across scenarios, its not the same
individuals that are affected (see Figure~\ref{fig-tran_by_group1} and
...
\subcaption{\label{fig-def2}Average Time Deficits for Time Poor
Individuals}
...
Finally, we present the changes in the LIMTIP estimates across the
