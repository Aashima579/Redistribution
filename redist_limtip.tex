...
\captionsetup{labelsep=none}Waffle plot of the distribution of
individuals across the different types of time poor households
...
\caption{\label{fig-transition1}Probably use Lines to represent the
...
\caption{\label{fig-transition2}Probably use Lines to represent the
changes Side by Side}
...
\caption{\label{fig-transition}Perhaps Mandoline plot}
