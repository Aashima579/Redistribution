...
Because there are individuals (young adults) who may still be in school, the standard definition of $Z_{ij}$ may not capture their true time availability. To address this, we add a correction to their time availability, based on how many hours people spend in education activities per week, if they declare to be in school. This correction does not affect the time balance used for the identification of the time poor. have less time available than their time balance $Z_{ij}$ may suggest
